<template>
  <nav class="navbar container">
    <div class="navbar-logo">
      <router-link id="logo-footer" :class="`nav-link`" :to="{
        name: 'home',
      }">
        <img src="https://res.cloudinary.com/renegade-bio/image/upload/branding/renegade-bio-logo-alt.svg"
          title="renegade.bio" alt="renegade.bio logo" />
      </router-link>
    </div>

    <ul class="nav-collection">
      <li v-for="collection in menu" :id="collection.id" :key="collection.id" class="collection-item">
      ...
      <ul id="social-media-links">
        <li>
          <a href="https://www.instagram.com/renegade.bio/" rel="noopener" target="_blank">
            <img src="https://res.cloudinary.com/renegade-bio/image/upload/icons/icon-social-instagram.svg"
              title="Instagram" alt="Instagram Logo" />
          </a>
        </li>
        <li>
          <a href="https://www.facebook.com/renegad3bio/" rel="noopener" target="_blank">
            <img src="https://res.cloudinary.com/renegade-bio/image/upload/icons/icon-social-facebook.svg"
              title="Facebook" alt="Facebook Logo" />
          </a>
        </li>
        <li>
          <a href="https://www.linkedin.com/company/renegadebio/" rel="noopener" target="_blank">
            <img src="https://res.cloudinary.com/renegade-bio/image/upload/icons/icon-social-linkedin.svg"
              title="LinkedIn" alt="LinkedIn Logo" />
          </a>
        </li>
        <li>
          <a href="https://www.youtube.com/channel/UC2AYtb-ZzdydDERG9xkDhmQ" rel="noopener" target="_blank">
            <img src="https://res.cloudinary.com/renegade-bio/image/upload/icons/icon-social-youtube.svg" title="YouTube"
              alt="YouTube Logo" />
          </a>
        </li>
      </ul>
