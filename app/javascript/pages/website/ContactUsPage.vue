<template>
  <div :id="`${parent.id}-page`" class="page">
    ...
    <ContactForm :data="contactFormData" :parent="parent" />
    ...
    copyBlocks: [
      {
        ...
        content: `
          ...
          <p class="p2">
            renegade.bio provides diagnostic testing for individuals, workplaces, schools, communities, events, concerts, and festivals.
          </p>
        `,
      },
    ],
