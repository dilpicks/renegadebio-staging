...
<style setup scoped lang="scss">
  ...
  .section.for-everyones-health {
    ...
    // min-height: 21.6rem;
    min-height: calc(var(--scaling-factor) * 26.6rem);
    ...
    &:deep() {
      ...
      .word-rotator {
        ...
        span {
          ...
          font-size: clamp(1rem, calc(var(--scaling-factor) * 6.4rem), 6.4rem);
          ...
          &:nth-of-type(3n + 2) {
            ...
            // line-height: 11.5rem;
            line-height: calc(var(--scaling-factor) * 11.5rem);

            font-size: clamp(3.2rem, calc(var(--scaling-factor) * 9.6rem), 9.6rem);
          }
      ...
      // #shape-home-for-everyones-health {
      //   // top: -98.2rem;
      //   // top: -103.2rem;
